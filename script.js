...
console.log(checkTypeNumber(10), ". Output ini bertipe data", typeof(checkTypeNumber(10)))
...
function getAngkaTerbesarKedua(dataNumbers){
  ...
  const sortNumbers = newDataNumbers.sort(function(a,b) {return b-a})
...
console.log("Angka terbesar kedua adalah", getAngkaTerbesarKedua(dataAngka), ". Output ini bertipe data", typeof(getAngkaTerbesarKedua(dataAngka)))
...
console.log("Total penjualan adalah", getTotalPenjualan(dataPenjualanPakAldi), ". Output ini bertipe data", typeof(getTotalPenjualan(dataPenjualanPakAldi)))
...
function getInfoPenjualan(dataPenjualan) {
  if(Array.isArray(dataPenjualan)){
    ...
    const totalKeuntunganFormat = totalKeuntungan.toLocaleString('id-ID', {style: 'currency', currency: 'IDR'})
    ...
    const totalModalFormat = totalModal.toLocaleString('id-ID', {style: 'currency', currency: 'IDR'})
...
console.log(getInfoPenjualan(dataPenjualanNovel), ". Output ini bertipe data", typeof(getInfoPenjualan(dataPenjualanNovel)))
